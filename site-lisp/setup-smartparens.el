...
(define-key sp-keymap (kbd "s-<left>") 'sp-forward-barf-sexp)
(define-key sp-keymap (kbd "s-S-<left>") 'sp-backward-slurp-sexp)
(define-key sp-keymap (kbd "s-S-<right>") 'sp-backward-barf-sexp)
